...
const TRAVEL_OPTIONS = [
  {
    ...
    features: [
      ...
      'Нові та корисні знайомства під час подорожей',
    ],
...
function TravelOptions() {
  ...
  return (
    <section
      ...
      id='travel-options'
    >
      <h2 className='text-4xl font-bold text-black text-center'>Можливості для спільних поїздок</h2>
      <div
        ref={travelRef}
      ...
      >
        {TRAVEL_OPTIONS.map((option, index) => (
          ...
          >
            ...
            <p className='text-2xl mb-2'>{option.description}</p>
            <div className='features text-left'>
              <h4 className='text-2xl font-semibold mb-2 '>Переваги:</h4>
