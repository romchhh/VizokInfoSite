...
const PURCHASES = [
  {
    ...
    title: 'Пройдіть авторизацію в боті @VizokUAbot',
  ...
  },
  {
    ...
    title: 'Оформіть свій профіль, додайте ваше фото та авто',
  ...
  },
  {
    ...
    title: 'Заповніть інші дані про поїздку, такі як: час, маршрут, кількість пасажирів',
  ...
  },
  {
    ...
    title: 'Тепер просто очікуйте на повідомлення від пасажирів',
